function Offspring = GAPrime(SubProblem,Parent,Parameter)
    ...
    Offspring = GAreal(Parent1,Parent2,SubProblem.lower,SubProblem.upper,proC,disC,proM/size(Parent1,2),disM);
